...
class VBFresonanceToWWSaveCorrectedSDMass : public uhh2::Hists{
  public:
  VBFresonanceToWWSaveCorrectedSDMass(uhh2::Context & ctx, const std::string & dirname);//, const std::string & collection = " ");
