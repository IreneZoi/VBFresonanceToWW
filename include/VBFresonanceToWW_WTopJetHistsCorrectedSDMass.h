...
class VBFresonanceToWW_WTopJetHistsCorrectedSDMass : public uhh2::Hists{
  public:
  VBFresonanceToWW_WTopJetHistsCorrectedSDMass(uhh2::Context & ctx, const std::string & dirname);//, const std::string & collection = " ");
